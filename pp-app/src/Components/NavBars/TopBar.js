...
export function TopBar(setShowSideBar, setToggleDropdown) {
    return <div className="bg-transparent container sm:h-10 fix mx-auto top-0 left-0">
        <div className="mt-4 flex flex-row justify-between mx-9">
            <button onClick={() => { setShowSideBar(true); setToggleDropdown(false); }} className="inline-flex items-center p-3 mt-2 ml-3 text-md text-gray-700 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-200">
